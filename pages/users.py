...
class UsersPage(LabelPage):
    ...
    def content(self):
        ...
        self.users_table.column('username', anchor='w')
        self.users_table.column('name', anchor='w')
        ...
        self.users_table.heading('username', text='Username', anchor='w')
        self.users_table.heading('name', text='Full Name', anchor='w')
