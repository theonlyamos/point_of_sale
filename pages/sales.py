...
class SalesPage(LabelPage):
    ...
    def content(self):
        ...
        self.sales_table.column('salesperson', anchor='w')
        self.sales_table.column('count', anchor=CENTER)
        self.sales_table.column('total', anchor='e')
        ...
        self.sales_table.heading('salesperson', text='Sold By', anchor='w')
        self.sales_table.heading('count', text='Items Count', anchor=CENTER)
        self.sales_table.heading('total', text='Total', anchor='e')
